...
int main() {
    std::vector<std::string> filenames = { "Doc1.txt", "Doc2.txt", "Doc3.txt", "Doc4.txt", "Doc5.txt" };
    ...
    std::vector<std::string> result = intersect_terms(inverted_index, terms);

    std::cout << "\nResult of INTERSECT operation for terms ";
